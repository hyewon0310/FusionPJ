...
//    }
    ...
    public String[] scheduleList_viewReq() throws Exception {
        ...
        String[] nameList= responseNameList.byteToStringArray(responseNameList.getBody(),5);
        ...
        Protocol responsePeriodList = receive(Protocol.TYPE7_VIEW_RES, Protocol.T7_CODE17_SELECTION_PERIOD_OF_SCHEDULE_LIST);
        String[] periodList = responsePeriodList.byteToStringArray(responsePeriodList.getBody(),10);
